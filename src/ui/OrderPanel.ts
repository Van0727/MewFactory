...
export class OrderPanel {
  ...
  private quantityHeaderEl: HTMLElement;

  constructor(overlay: HTMLElement) {
    this.el = document.createElement('div');
    this.el.className = 'order-panel-root is-hidden';
    this.el.innerHTML = `
      <p class="order-panel__quantity-header"></p>
    ...
    this.quantityHeaderEl = this.el.querySelector('.order-panel__quantity-header')!;
  ...
  private update(order: Order): void {
    this.quantityHeaderEl.textContent = `${order.delivered}/${order.quantity}`;
